...
if __name__ == '__main__':
    ...
    conn = psycopg2.connect(database = conf['pg_x']['database'], user = conf['pg_x']['user'], password = conf['pg_x']['password'])
    # conn = psycopg2.connect(database = conf['pg']['database'], user = conf['pg']['user'], password = conf['pg']['password'])
